...
def main(filename):
    ...
    # Prepara a solução inicial para a pesquisa local
    initial_solution = read_initial_solution("capABC/initial_solution_ABC.txt")
    
    # Executa a pesquisa local
...
if __name__ == "__main__":
    filename = "FicheirosTeste/ORLIB/capc.txt"  # Nome do arquivo de entrada
    main(filename)
