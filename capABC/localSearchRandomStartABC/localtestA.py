...
def read_data(filename):
    ...
    # Leitura dos armazéns com capacidade substituída por 58268
    for i in range(1, m + 1):
        # Substitui "capacity" por 58268
        data['warehouses'].append({'capacity': 58268, 'fixed_cost': float(lines[i].split()[1]), 'allocated': 0, 'opened': False})
...
def calculate_total_cost(solution, warehouses, customers):
    ...
    for customer_idx, warehouse_idx in enumerate(solution):
        ...
        # Marca o armazém como aberto se ainda não estiver aberto
